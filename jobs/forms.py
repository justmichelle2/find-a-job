...
class JobPostForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'category', 'job_type', 'deadline', 'salary', 'currency'
        ]
        widgets = {
...
class ApplicationForm(forms.ModelForm):
    ...
    class Meta:
        model = Application
        fields = ['cover_letter', 'cv', 'transcript', 'certificate', 'other_document']
        widgets = {
            ...
            'other_document': forms.FileInput(attrs={'class': 'form-control'}),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['cv'].help_text = "Upload your CV/Resume (Required - PDF, DOC, DOCX)"
